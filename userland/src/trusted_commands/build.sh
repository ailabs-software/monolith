...
/opt/monolith/core/dart_sdk/bin/dart compile aot-snapshot lib/docker.dart -o /opt/monolith/userland/system/trusted/bin/docker.aot
# set trusted bit
...
/opt/monolith/core/dart_sdk/bin/dartaotruntime /opt/monolith/core/bin/set_trusted_executable.aot /system/trusted/bin/docker.aot "1"
